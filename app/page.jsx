...
import Sidebar from "./components/sidebar"; // Fix path (lowercase)
  ...
  return (
    <div>
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-while relative">
