        ...
        <div>
            <div className={`flex ${expand ? "flex-row gap-10" : "flex-col items-center gap-8"}`}>
             ...
             <button className={`mt-8 flex items-center justify-center cursor-pointer
                ...
                <Image className={expand ? 'w-6' : 'w-7'} src={expand ? assets.chat_icon : assets.arrow_icon_dull} alt='' />
                <div className='absolute w-max -top-12 opacity-0 group-hover:opacity-100 transition bg-black 
         ...
         <div>
            <div className={`flex items-center cursor-pointer group relative ${expand? "gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10cursor-pointer" : " h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
